# 全站 SEO 翻新工程：深耕計畫 2026 (進度追蹤表)

- [ ] 目標：將站上 58 篇文章全部升級至 v3.1 規格 (H1 招牌 + 內部連結 + 三階層頁尾)。
- [ ] 執行頻率：每日深夜自動精修 3-5 篇。

| 序號 | 文章標題 | 網址 | 狀態 | 精修日期 |
|---|---|---|---|---|
| 1 | 別讓除夕大掃除，演變成靈魂之窗的「化學戰爭」 | https://www.uncle-glasses.net/2026/02/eye-safety-cleaning-chemical-burns.html | [x] 已完成 | 2026-02-15 |
