...
// 2. 語助詞庫 - Natural interjections, categorized by tone mood
export type InterjectionMood = 'chill' | 'earnest' | 'emotional' | 'neutral';

export interface TaggedInterjection {
  text: string;
  mood: InterjectionMood;
}

export const INTERJECTIONS_TAGGED: TaggedInterjection[] = [
  // Chill / casual
  { text: '還好啦', mood: 'chill' },
  { text: '就…', mood: 'chill' },
  { text: '其實也還行', mood: 'chill' },
  { text: '沒什麼好挑的', mood: 'chill' },
  { text: '反正', mood: 'chill' },
  { text: '隨便啦', mood: 'chill' },
  // Earnest / serious
  { text: '老實說', mood: 'earnest' },
  { text: '說真的', mood: 'earnest' },
  { text: '講實話', mood: 'earnest' },
  { text: '認真講', mood: 'earnest' },
  { text: '基本上', mood: 'earnest' },
  { text: '整體而言', mood: 'earnest' },
  // Emotional / expressive
  { text: '沒想到', mood: 'emotional' },
  { text: '真的欸', mood: 'emotional' },
  { text: '天啊', mood: 'emotional' },
  { text: '超感動', mood: 'emotional' },
  { text: '哇', mood: 'emotional' },
  { text: '讚嘆', mood: 'emotional' },
  // Neutral (fits any tone)
  { text: '其實啦', mood: 'neutral' },
  { text: '欸', mood: 'neutral' },
  { text: '結果', mood: 'neutral' },
  { text: '真的', mood: 'neutral' },
  { text: '不過', mood: 'neutral' },
  { text: '感覺', mood: 'neutral' },
  { text: '好像', mood: 'neutral' },
  { text: '畢竟', mood: 'neutral' },
  { text: '大概', mood: 'neutral' },
  { text: '總之', mood: 'neutral' },
];

// Legacy flat list for backward compat
export const INTERJECTIONS = INTERJECTIONS_TAGGED.map(i => i.text);
...
export function selectInterjections(count: number = 2, mood?: InterjectionMood): string[] {
  // Filter by mood: pick from matching mood + neutral pool
  let pool = INTERJECTIONS_TAGGED;
  if (mood) {
    pool = INTERJECTIONS_TAGGED.filter(i => i.mood === mood || i.mood === 'neutral');
  }
  const shuffled = [...pool].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, count).map(i => i.text);
}
