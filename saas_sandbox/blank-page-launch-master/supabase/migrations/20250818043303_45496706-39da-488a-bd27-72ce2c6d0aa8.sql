...
-- 2) Create or replace approval function to extend from existing expiry/trial
...
DECLARE
  ...
  _plan text := 'monthly'; -- default; can be extended later
  _interval interval := interval '30 days'; -- monthly
BEGIN
