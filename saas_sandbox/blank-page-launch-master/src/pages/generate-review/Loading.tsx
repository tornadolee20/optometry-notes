    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-lg mx-auto p-4 space-y-6">
        ...
        <motion.div 
          ...
          className="bg-card rounded-2xl shadow-sm p-6 space-y-6"
        >
          {/* 標題區域 */}
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative">
              ...
              <Sparkles className="absolute inset-2 h-8 w-8 text-primary animate-pulse" />
            </div>
            <div className="text-center space-y-1">
              <p className="text-muted-foreground font-medium">正在準備您的專屬關鍵字</p>
              <p className="text-sm text-muted-foreground/80">根據店家特色智能生成中...</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground text-center">預計還需要 3-5 秒</p>
          </div>
        ...
        >
          <div className="flex items-start space-x-3">
            <Store className="h-5 w-5 text-accent-foreground mt-0.5 flex-shrink-0" />
