...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authError) {
        ...
        const status = 'status' in authError ? (authError as unknown as { status: number }).status : undefined;
        const code = 'code' in authError ? (authError as unknown as { code: string }).code : undefined;
      ...
      case 1:
        return <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-semibold text-brand-sage-dark">歡迎加入 Myownreviews！</h3>
              <p className="text-muted-foreground mt-2">快速開始或填寫店家資訊</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">店家名稱</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">電子郵件</label>
      ...
      case 2:
        return <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground mt-2">保護您的帳號安全</p>
            </div>
            
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">密碼</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">確認密碼</label>
      ...
      case 3:
        return <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground mt-2">最後一步，讓客戶更容易找到您</p>
            </div>
            
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">店家地址</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80">聯絡電話</label>
  ...
  return <div className="min-h-screen bg-gradient-to-br from-brand-sage-light/20 via-background to-brand-sage/10">
      {/* Header */}
      <div className="bg-background/80 backdrop-blur-md border-b border-brand-sage/10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <img src="/lovable-uploads/40b8add3-b8f5-4e78-8a90-9987bc19b773.png" alt="Myownreviews" className="w-6 h-6" />
              <span className="font-semibold text-brand-sage-dark">Myownreviews</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        y: 0
          ...
          <Card className="border-0 shadow-xl bg-background/90 backdrop-blur-sm">
            ...
            <CardContent>
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  {currentStep < totalSteps ? <Button type="button" onClick={handleNextStep} disabled={!isStepValid(currentStep)} className={`${currentStep === 1 ? 'w-full' : 'flex-1'} bg-gradient-to-r from-brand-sage to-brand-sage-dark text-primary-foreground hover:from-brand-sage-dark hover:to-brand-sage shadow-lg`}>
                      下一步
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button> : <Button type="submit" disabled={!isStepValid(currentStep) || isLoading} className="flex-1 bg-gradient-to-r from-brand-sage to-brand-sage-dark text-primary-foreground hover:from-brand-sage-dark hover:to-brand-sage shadow-lg">
