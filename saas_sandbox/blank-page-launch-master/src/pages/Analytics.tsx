                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Badge 
                      variant="secondary" 
                      className={`text-xs ${
                        metric.trend === 'up' ? 'text-status-success-fg bg-status-success-bg' : 
                        metric.trend === 'down' ? 'text-status-error-fg bg-status-error-bg' : 
                    ...
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge 
                          variant="secondary"
                          className={`${
                            keyword.trend === 'up' ? 'text-status-success-fg bg-status-success-bg' :
                            keyword.trend === 'down' ? 'text-status-error-fg bg-status-error-bg' :
                            'text-muted-foreground bg-muted'
                          }`}
                        >
          ...
          >
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-status-success-bg rounded-lg border border-status-success-border">
                  <div className="flex items-center gap-2 mb-2">
                    <Sparkles className="w-5 h-5 text-status-success-fg" />
                    <h4 className="font-semibold text-status-success-fg">AI 分析建議</h4>
                  </div>
                  <p className="text-status-success-fg text-sm">
