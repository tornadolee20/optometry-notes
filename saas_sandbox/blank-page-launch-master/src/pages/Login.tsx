...
import { ArrowLeft, LogIn, Shield, CheckCircle, Eye, EyeOff } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-sage-light/20 via-background to-brand-sage/10">
      {/* Header */}
          ...
          <Card className="border-0 shadow-xl bg-background/90 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-brand-sage to-brand-sage-dark text-primary-foreground hover:from-brand-sage-dark hover:to-brand-sage shadow-lg"
