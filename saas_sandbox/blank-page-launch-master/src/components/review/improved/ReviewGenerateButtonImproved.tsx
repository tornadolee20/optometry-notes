        ...
        <motion.div
          ...
          aria-live="polite">
            ...
            <div className="flex items-center gap-2 text-yellow-700">
              ...
              <span className="text-sm">請先選擇至少 3 個關鍵感受才能開始撰寫評論</span>
            </div>
          </motion.div>
        }
      </AnimatePresence>
        ...
        <motion.div
          ...
          aria-label="評論生成進度">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-foreground" id="progress-label">撰寫進度</span>
                  <span className="text-sm text-primary" aria-live="polite">{Math.round(progress)}%</span>
                </div>
                <Progress
                value={progress}
              ...
              aria-label="當前處理階段">
                ...
                <span className="text-sm text-foreground/80">{currentStage}</span>
              </motion.div>

              {/* 時間預估 */}
              <div className="flex items-center justify-between text-xs text-muted-foreground" role="timer" aria-live="polite">
            ...
            <div className="flex justify-center pt-2">
              ...
              {/* 提示文字 */}
              <div className="text-xs text-primary bg-primary/10 rounded-lg p-2 text-center">
