      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-muted-foreground">銀行</p>
              <p className="font-medium">中國信託銀行</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">分行</p>
              <p className="font-medium">中崙分行</p>
            </div>
          </div>
          <div>
            <p className="text-sm text-muted-foreground">戶名</p>
            <p className="font-medium">李錫彥</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground">銀行帳號</p>
            <p className="font-mono text-lg font-bold text-primary">093-53405060-1</p>
          </div>
          <p className="text-sm text-muted-foreground">轉帳完成後，請輸入您的轉帳帳號末 5 碼以供管理員確認</p>
