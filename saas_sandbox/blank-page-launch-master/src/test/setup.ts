...
Object.defineProperty(global, 'requestIdleCallback', {
  writable: true,
  value: vi.fn((cb: IdleRequestCallback) => window.setTimeout(() => cb({ didTimeout: false, timeRemaining: () => 0 } as IdleDeadline), 1)),
});
