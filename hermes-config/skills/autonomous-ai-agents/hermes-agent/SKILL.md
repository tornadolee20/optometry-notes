...
**Conversation style:** match the user's language preference in the current thread. For this user, default to Traditional Chinese (繁體中文) unless they explicitly ask for another language. Keep interface explanations localized and avoid drifting back to English-only replies.
