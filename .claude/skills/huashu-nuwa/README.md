...
**以彼之道，還之彼身，帮你蒸馏任何人的思维方式，让乔布斯、马斯克、芒格、费曼都给你打工。**

<br>

[同事.skill](https://github.com/titanwings/colleague-skill) 证明了蒸馏一个人是可行的。<br>
那何必蒸馏同事？去蒸馏乔布斯、芒格、费曼、马斯克。<br>
只需输入一个名字，这套流程自动完成调研、提炼、验证全流程。也可以直接进入 **Board Mode**，让多个已蒸馏人物对同一个问题做交叉裁决。

[看效果](#效果示例) · [安装](#安装) · [它蒸馏了什么](#它蒸馏了什么) · [工作原理](#工作原理)
...
蒸馏各领域最强的人，需要提取比日常工作习惯更深的东西。这套流程提取五层：
...
工作习惯可以靠流程文档传递，但让芒格和马斯克面对同一个问题做出不同判断的，是认知框架。這套流程提取的是认知操作系统。
...
這套流程已蒸馏了13位人物 + 1个主题。每个都是独立的、可直接安装使用的Skill：
...
想蒸馏不在列表里的人或主题？安装这套技能后，说「蒸馏一个XXX」就行。
...
**以彼之道，還之彼身**，这里的材料是公开信息，造出来的不是人，是一面镜子。
